        ...
        <div className="mx-auto w-full max-w-xl px-6 py-16">
            ...
            >
                ...
                <p className="text-caption text-muted-foreground max-w-md">
                    Waehle oder starte zunaechst einen Incident, um die Auswertung
                    und den Abschlussbericht einzusehen.
                </p>
                <Button
                    size="sm"
                    onClick={() => navigate("/")}
...
/* ====================================================================
   ABSCHLUSS-CHECK Tab
==================================================================== */
function AbschlussCheckTab({ check, loading, onRefresh, onFreigabe, canFreigabe, incident }) {
    if (loading || !check) {
        return (
                ...
                <article className="report-a4" data-testid="report-a4">
                        ...
                        <dl className="kv">
                            ...
                            <dd>
                                <span className="pill pill-red">
                                    {k[3].inhalt.sichtung.S1}
                                </span>
                            </dd>
                            <dt>S2 · dringend</dt>
                            <dd>
                                <span className="pill pill-yellow">
                                    {k[3].inhalt.sichtung.S2}
                                </span>
                            </dd>
                            <dt>S3 · normal</dt>
                            <dd>
                                <span className="pill pill-green">
                                    {k[3].inhalt.sichtung.S3}
                                </span>
                            </dd>
                            <dt>S0 · leicht</dt>
                            <dd>
                                <span className="pill pill-gray">
                                    {k[3].inhalt.sichtung.S0}
                                </span>
                            </dd>
                        </dl>
                    </section>
                    ...
                    <section className="kap">
                        ...
                        <dl className="kv">
                            ...
                            <dt>intern / extern</dt>
                            <dd>
                                {k[7].inhalt.summary.typ.intern} /{" "}
                                {k[7].inhalt.summary.typ.extern}
                            </dd>
                            <dt>Ø Fahrtdauer</dt>
                    ...
                    <section className="kap">
                        ...
                        <p>
                            ...
                            <span className="pill pill-yellow">
                                {k[10].inhalt.gelb} gelb
                            </span>{" "}
                            von insgesamt {k[10].inhalt.total} Konflikten.
                        </p>
                    </section>
                    ...
                    <section className="kap">
                        ...
                        <dl className="kv">
                            <dt>Status</dt>
                            <dd>
                                {k[13].inhalt.bereit_fuer_abschluss
                                    ? "Freigegeben"
                                    : "Ausstehend"}
                            </dd>
...
export default function AbschlussPage() {
    const navigate = useNavigate();
    const { activeIncident, closeIncident, refresh: refreshIncidents } =
        useIncidents();
        ...
        <div className="mx-auto w-full max-w-[1400px] px-6 py-6 no-print">
            ...
            <div className="mb-5 flex flex-wrap items-end justify-between gap-4">
                <div>
                    ...
                    <h1
                        ...
                        data-testid="abschluss-title"
                    >
                        Abschluss & Bericht
                    </h1>
                    <p className="mt-1 max-w-2xl text-body text-muted-foreground">
                        Dashboard-KPIs, Abschluss-Check, A4-Berichtsvorschau,
                        Nachbearbeitung und Versionierung – alles fuer ein
                        sauberes Einsatzende.
                    </p>
                </div>
                <Button
                    variant="outline"
            ...
            {report && (
                <div className="hidden print:block print-area">
                    {/* Rendered from ReportPreviewTab inside tab – we re-render for print below */}
                </div>
            )}
