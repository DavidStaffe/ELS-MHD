...
import { KpiTile, StatusBadge, ConfirmModal } from '@/components/primitives';
...
export default function TransportList() {
  ...
  const { transports, loading, error, refresh, create, update, remove, kpis } =
    useTransports();
    ...
    return (
      <div className="mx-auto max-w-xl p-6">
        <div
          ...
          data-testid="transport-no-incident"
        >
  ...
  if (activeIncident.status === 'geplant') {
    return (
      <div className="mx-auto max-w-xl p-6">
        <div
          className="els-surface p-6 text-center"
          data-testid="transport-planned-incident"
        >
          <h2 className="text-display">Incident ist geplant</h2>
          <p className="mt-2 text-muted-foreground">
            Transporte koennen erst zugewiesen werden, wenn der Incident auf
        ...
        <div className="mx-auto w-full max-w-[1600px]">
          ...
          {loading && transports.length === 0 ? (
            ...
            >
              ...
              <div>
                <h3 className="text-heading">Noch keine Transporte</h3>
                <p className="mt-1 max-w-md text-caption text-muted-foreground">
                  Transporte entstehen automatisch, wenn ein Patient eine
                  Transportanforderung erhaelt.
                </p>
              </div>
              <Button
                variant="outline"
