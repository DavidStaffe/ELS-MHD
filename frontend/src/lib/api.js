...
export async function createTransport(incidentId, payload) {
  const { data } = await api.post(
    `/incidents/${incidentId}/transports`,
    payload,
  );
  return data;
}
...
export async function listResources(incidentId, params = {}) {
  const { data } = await api.get(`/incidents/${incidentId}/resources`, {
    params,
  });
  return data;
}
export async function createResource(incidentId, payload) {
  const { data } = await api.post(
    `/incidents/${incidentId}/resources`,
    payload,
  );
  return data;
}
...
export async function ackMessage(id, by) {
  const { data } = await api.post(`/messages/${id}/ack`, null, {
    params: by ? { by } : {},
  });
  return data;
}
...
export async function finalizeMessage(id, by) {
  const { data } = await api.post(`/messages/${id}/finalize`, null, {
    params: by ? { by } : {},
  });
  return data;
}
...
export async function listAbschnitte(incidentId, params = {}) {
  const { data } = await api.get(`/incidents/${incidentId}/abschnitte`, {
    params,
  });
  return data;
}
export async function createAbschnitt(incidentId, payload) {
  const { data } = await api.post(
    `/incidents/${incidentId}/abschnitte`,
    payload,
  );
  return data;
}
...
export async function createBettenBulk(incidentId, payload) {
  const { data } = await api.post(
    `/incidents/${incidentId}/betten/bulk`,
    payload,
  );
  return data;
}
...
export async function assignBett(bettId, patientId) {
  const { data } = await api.post(`/betten/${bettId}/assign`, {
